...
.config(function($stateProvider,$urlRouterProvider){
	$stateProvider
		...
		.state('adel',{
		url: '/adel',
		templateUrl: 'templates/adel.html',
		controller: 'DelCtrl'
	})
		.state('minsert',{
		url: '/minsert',
		templateUrl: 'templates/minsert.html',
...
.controller('PlaylistCtrl',function($scope){
	$scope.datalist=[
	{fname:"Chelsae",lname:"cfc",pic:"img/01.jpg"},
	{fname:"Chelsae",lname:"cfc",pic:"img/02.jpg"},
	{fname:"Chelsae",lname:"cfc",pic:"img/03.jpg"},
	{fname:"Chelsae",lname:"cfc",pic:"img/04.jpg"},
	{fname:"Chelsae",lname:"cfc",pic:"img/05.jpg"}
...
var url="http://localhost/ionic_php/";
	...
	$scope.createAdmin=function(){
      var admin_user=$scope.adminData.admin_username;
...
var url="http://localhost/ionic_php/";
	...
	$scope.editAdmin=function(){
	  var admin_id=$scope.editData.admin_id;
      var admin_user=$scope.editData.admin_username;
      var admin_password=$scope.editData.admin_password;
      console.log(admin_user);
...
.controller('DelCtrl',function($scope,$http){
var url="http://localhost/ionic_php/";
	$scope.delData=[];
	$scope.deleteAdmin=function(){
	  var admin_id=$scope.delData.admin_id;
...
var url="http://localhost/ionic_php/";
	...
	$scope.createMember=function(){
      var fname=$scope.memberData.fname;
      var lname=$scope.memberData.lname;
	  var pic=$scope.memberData.pic;
      console.log(fname);
	str= url + "member-insert.php?fname=" + fname + "&lname=" + lname + "&pic=" + pic ;
	$http.get(str)
	.success(function(data){
	if(data == true){
		console.log("ok");
